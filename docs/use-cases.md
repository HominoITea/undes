...
Undes is useful when AI-generated engineering work needs evidence checking and an explicit trust boundary before merge, release, or a risky implementation decision.
